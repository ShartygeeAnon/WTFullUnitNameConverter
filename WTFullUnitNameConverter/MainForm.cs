...
namespace WTFullUnitNameConverter
{
    public partial class MainForm : Form
    {
        ...
        public class InternalSturctureMap : ClassMap<InternalStructure>
        {
            public InternalSturctureMap()
            {
        ...
        private void button2_Click(object sender, EventArgs e)
        {
            ...
            else
            {
                try
                {
                    ...
                    {
                        csvReader.Context.RegisterClassMap<InternalSturctureMap>();
                    ...
                    {
                        csvWriter.Context.RegisterClassMap<InternalSturctureMap>();
